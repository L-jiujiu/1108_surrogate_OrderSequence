...
def read_data(filename):
    ...
    print("Tasks: \n", tasks)
    file.close()
    # print(tasks_val,machines_val,tasks)
    return 6557, 6, tasks
...
def init_skuorder():
    ...
    # data = pd.read_excel(cwd + '/Fa_data/OrderPickDetail_less.xlsx', sheet_name='Part 1', usecols='A,B,C,D',
    #                      names=['OrderID', 'CommodityID', 'Amount', 'PosGroupID'])
    data = pd.read_excel(cwd + '/Fa_data/OrderPickDetail.xlsx', sheet_name='Part 1', usecols='A,B,C,D',
                         names=['OrderID', 'CommodityID', 'Amount', 'PosGroupID'])
...
if __name__=="__main__":
    ...
    tasks_val, machines_val, tasks=init_skuorder()
